;-------------------------------------------------------------------------------
; test unWBRLE2VRAM 
; Assemble with [tniASM](http://tniasm.tni.nl/)
; Format: MSX ROM
;-------------------------------------------------------------------------------
...
MSXID1: EQU $002B ;Basic ROM version 1/3
MSXID2: EQU $002C ;Basic ROM version 2/3
MSXID3: EQU $002D ;Basic ROM version 3/3 - MSX version number
...
TILESET_col:
    ...
    DS 4000h - ($ - 4000h),255;Fill the unused aera with 0FFh
